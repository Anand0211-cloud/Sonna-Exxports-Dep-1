                        ...
                        <div className="max-w-4xl mx-auto animate-fade-in-up">
                            ...
                            <section className="mb-24">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                                    {/* School Uniforms */}
                                    <div
                                        className={`group bg-white dark:bg-gray-900 p-6 border transition-all duration-300 hover:shadow-xl hover:-translate-y-1 rounded-lg relative overflow-hidden cursor-pointer ${activeCategory === 'school' ? 'border-primary ring-1 ring-primary shadow-lg' : 'border-gray-100 dark:border-gray-800'}`}
                                        onMouseEnter={() => setActiveCategory('school')}
                                        onClick={() => setActiveCategory('school')}
                                    >
                                        <div className="aspect-w-1 aspect-h-1 w-full mb-6 rounded-md overflow-hidden bg-gray-100 dark:bg-gray-800">
                                            <img
                                    ...
                                    {/* Industrial Uniforms */}
                                    <div
                                        className={`group bg-white dark:bg-gray-900 p-6 border transition-all duration-300 hover:shadow-xl hover:-translate-y-1 rounded-lg relative overflow-hidden cursor-pointer ${activeCategory === 'industrial' ? 'border-primary ring-1 ring-primary shadow-lg' : 'border-gray-100 dark:border-gray-800'}`}
                                    ...
                                    {/* Corporate Uniforms */}
                                    <div
                                        className={`group bg-white dark:bg-gray-900 p-6 border transition-all duration-300 hover:shadow-xl hover:-translate-y-1 rounded-lg relative overflow-hidden cursor-pointer ${activeCategory === 'corporate' ? 'border-primary ring-1 ring-primary shadow-lg' : 'border-gray-100 dark:border-gray-800'}`}
                                            ...
                                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                                                {uniformDetails[activeCategory].variants.map((variant, index) => (
                                                    <div key={index} className="group">
                                                        <div className="relative aspect-[4/5] rounded-lg overflow-hidden bg-gray-200 mb-3">
                                                            <img
                                                                src={variant.image}
                                                                alt={variant.name}
                                                                className="w-full h-full object-cover transform transition-transform duration-700 group-hover:scale-110"
                                                        ...
                                                        <p className="text-sm font-medium text-gray-900 dark:text-white text-center">{variant.name}</p>
                                                    </div>
                                                ))}
                                            </div>
                                        </div>
                                    ...
                                    <div className="flex flex-col md:flex-row md:items-start gap-8 group">
                                        <div className="md:w-1/3">
                                            <div className="flex items-center space-x-3 text-primary mb-2">
                                                ...
                                                <h4 className="font-display text-xl text-gray-900 dark:text-white">Screen Printing</h4>
                                            </div>
                                        </div>
                                        <div className="md:w-2/3">
                                            <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed mb-4">
                                                Using high-fidelity eco-friendly inks, we achieve exceptional color vibrancy and durability. From plastisol to water-based high-density prints.
                                            </p>
                                    ...
                                    <div className="flex flex-col md:flex-row md:items-start gap-8 group">
                                        <div className="md:w-1/3">
                                            <div className="flex items-center space-x-3 text-primary mb-2">
                                                ...
                                                <h4 className="font-display text-xl text-gray-900 dark:text-white">Premium Embroidery</h4>
                                            </div>
                                        </div>
                                        <div className="md:w-2/3">
                                            <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed mb-4">
                                                Multi-head precision embroidery featuring 3D puff effects, metallic threading, and intricate applique work for a tactile premium feel.
                                            </p>
                                            <div className="h-px w-full bg-gray-100 dark:bg-gray-800 group-hover:bg-primary/30 transition-colors"></div>
                                        </div>
                                    </div>
                                    <div className="flex flex-col md:flex-row md:items-start gap-8 group">
                                        <div className="md:w-1/3">
                                            <div className="flex items-center space-x-3 text-primary mb-2">
                                                ...
                                                <h4 className="font-display text-xl text-gray-900 dark:text-white">Private Labeling</h4>
                                            </div>
                                        </div>
                                        <div className="md:w-2/3">
                                            <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed mb-4">
                                                Full-suite branding including custom woven neck labels, laser-cut hang tags, and sustainable bespoke packaging solutions.
                                            </p>
                                            <div className="h-px w-full bg-gray-100 dark:bg-gray-800 group-hover:bg-primary/30 transition-colors"></div>
                                        </div>
                                    </div>
