                    ...
                    <div className="grid lg:grid-cols-[1fr_1.4fr] gap-12 lg:gap-20 items-center">
                        <div className="flex flex-col gap-8 order-2 lg:order-1">
                            <div className="flex flex-col gap-2">
                                <h3 className="text-accent-beige text-sm font-bold tracking-[0.3em] uppercase">The Art of Creation</h3>
                                <h2 className="text-4xl md:text-5xl lg:text-6xl font-serif text-white leading-tight">Making Video</h2>
                            </div>
                            ...
                            <div className="space-y-4 pt-4 border-t border-white/10">
                                <div className="flex items-center gap-4 text-white/80">
                                    <span className="material-symbols-outlined text-accent-beige">verified</span>
                                    <span className="text-sm uppercase tracking-wider">Certified Factory Standards</span>
                                </div>
                                <div className="flex items-center gap-4 text-white/80">
                                    <span className="material-symbols-outlined text-accent-beige">eco</span>
                        ...
                        <div className="relative order-1 lg:order-2">
                            <div className="relative w-full aspect-[4/3] lg:aspect-video rounded-2xl overflow-hidden shadow-2xl group">
                                <div className="absolute inset-0 bg-black/40 group-hover:bg-black/20 transition-colors z-10 flex items-center justify-center">
                                    <button className="size-24 md:size-32 flex items-center justify-center rounded-full bg-accent-beige text-primary-dark hover:scale-110 transition-transform duration-300 shadow-xl">
                            ...
                            <div className="absolute -z-10 -bottom-6 -right-6 size-48 bg-primary rounded-full blur-3xl opacity-20"></div>
                        </div>
                    </div>
                </div>
            </div>
