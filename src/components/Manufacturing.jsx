                ...
                <div className="w-full max-w-7xl">
                    <div className="grid lg:grid-cols-[1.4fr_1fr] gap-12 lg:gap-20 items-center">
                        <div className="relative order-1">
                            <div className="relative w-full aspect-[4/3] lg:aspect-video rounded-2xl overflow-hidden shadow-2xl group">
                                <img
                                ...
                                />
                                <div className="absolute inset-x-0 bottom-0 h-1/3 bg-gradient-to-t from-primary-dark/40 to-transparent z-20"></div>
                                <div className="absolute bottom-8 left-8 z-30 flex items-center gap-4">
                                    <div className="size-12 rounded-full border border-primary-dark/30 flex items-center justify-center backdrop-blur-md">
                                        <span className="material-symbols-outlined text-primary-dark text-sm">settings_suggest</span>
                                    </div>
                                    <div className="text-primary-dark">
                                        <p className="text-xs font-bold uppercase tracking-widest">Customization</p>
                                        <p className="text-sm opacity-80 font-medium">Bespoke Production Line</p>
                                    </div>
                                </div>
                            </div>
                            <div className="absolute -z-10 -bottom-6 -left-6 size-48 bg-primary-light rounded-full blur-3xl opacity-10"></div>
                        </div>
                        <div className="flex flex-col gap-8 order-2">
                            <div className="flex flex-col gap-2">
                                <h3 className="text-primary text-sm font-bold tracking-[0.3em] uppercase">Tailored for your brand</h3>
                                <h2 className="text-4xl md:text-5xl lg:text-6xl font-serif text-primary-dark leading-tight">Private Label & Custom Manufacturing</h2>
                            </div>
